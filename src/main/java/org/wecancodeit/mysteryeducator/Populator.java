...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Art neptuneArt = new Art("https://i.ibb.co/1JDbngT/Neptune.jpg", "A prodigious talent at fifteen, John Singleton Copley learned his trade by copying reproductions of Italian mythological paintings. This charming juvenilia depicting Neptune and his retinue reminds us that Copley and the sitters in his later, mature portraits lived along the New England Coast and were deeply connected—economically and psychologically—to the sea.");
        artRepo.save(neptuneArt);
        Art venusArt = new Art("https://i.ibb.co/MSjHNw1/Venus.jpg","The missing lower portion of this statuette makes it difficult to determine if the woman depicted was clothed. However, her preserved left hand, which pulls back her hair, recalls the gesture of Venus after she emerged newly born from the sea, the subject of a famous Greek sculptural type of the third to second century B.C.");
        artRepo.save(venusArt);
        Art earthArt = new Art("https://i.ibb.co/TrtWqjr/Earth-art.jpg","National Portrait Gallery, Smithsonian Institution; gift of Time magazine.");
       ...
       Planets mercury = new Planets("Mercury","https://i.ibb.co/2jZnPjD/Mercury.jpg", "https://i.ibb.co/L1r8RgB/mercury-art.jpg","Mercury is sometimes referred to as 'The Swift Planet.' The planet Mercury is the planet closest to the sun. Due to its proximity, it orbits the sun faster than any of the other planets. A year on Mercury is only 88 days. Mercury is also the smallest planet recognized by our solar system.", "30,915 million miles from the sun.", "Mercury has a diameter of 3,030 miles. Mercury is a little more than 1/3 the size of Earth.", mercuryHistory, mercuryArt);
       planetsRepo.save(mercury);
       Planets venus = new Planets("Venus","https://i.ibb.co/Jzp7Ncp/Venus.jpg", "https://i.ibb.co/MSjHNw1/Venus.jpg", "Despite being a planet and not a star, Venus is sometimes referred to by the nicknames of 'The Morning Star' and 'The Evening Star.' A day on Venus is longer than a year. It takes the planet longer to rotate once around its own axis than to rotate around the sun. From Earth, Venus is the second brightest object in the sky next to the moon. Also, despite being further from the sun than Mercury, Venus is actually the warmer planet.", "66,958 million miles from the sun.", "Venus has a diameter of 7,520 miles. Venus is often referred to as Earth's twin due to the fact it is 95% of the size of Earth.", venusHistory, venusArt);
       planetsRepo.save(venus);
       Planets earth = new Planets("Earth","https://i.ibb.co/F5P3bSh/Earth.jpg", "https://i.ibb.co/TrtWqjr/Earth-art.jpg", "Often referred to as 'The Blue Planet,' the Earth is made up of 70% water. Earth's abundance of water and oxygen make it the only planet known to contain life, in fact, millions of different forms of life. " , "94,488 million miles from the sun.", "Earth has a diameter of 7,918 miles.", earthHistory,earthArt);
       planetsRepo.save(earth);
       Planets mars = new Planets("Mars", "https://i.ibb.co/7YfPX86/NASAs-Hubble-Space-Telescope-photographed-Mars-on-July-18-near-its-closest-approach-to-Earth-since-2.jpg", "https://i.ibb.co/Qvw761t/mars-art.jpg", "Mars is the fourth planet from the Sun and the second-smallest planet in the Solar System, being larger than only Mercury. ", "155,780 million miles from the sun.","Mars has a diameter of 4,212 miles. Mars is slightly larger than half the size of Earth.", marsHistory, marsArt);
       planetsRepo.save(mars);
       Planets jupiter = new Planets("Jupiter",  "https://i.ibb.co/tLJnSrS/Jupiter-is-the-king-of-the-solar-system-more-massive-than-all-of-the-other-solar-system-planets-comb.jpg", "https://i.ibb.co/34KD59L/jupiter-art.jpg","Nicknamed the Gas Giant, Jupiter has a mass more than two and a half times that of all the other planets in the Solar System combined. Jupiter is actually so large you can see it with your own eyes in the night time sky. Despite being the largest planet, it has the shortest day of all the other planets at approximately ten hours long.", "468,280 million miles from the sun.", "Jupiter has a diameter of 86,881 miles. Jupiter is almost 318 times as large as Earth.", jupiterHistory, jupiterArt);
       planetsRepo.save(jupiter);
       Planets saturn = new Planets("Saturn", "https://i.ibb.co/s1JQGtM/Saturn.jpg", "https://i.postimg.cc/fLBWpxNM/saturn-art.jpg", "Saturn is often referred to as The Ringed Planet due to its most distinguishable feature, its large ring that encircles the planet. Another unique fact about Saturn is it actually gives off more energy than it receives from the sun. Saturn also has the fastest winds of any other planet in our solar system.", "923.55 million miles from the sun.", "Saturn has a diameter of 72,367 miles.", saturnHistory, saturnArt);
       planetsRepo.save(saturn);
       Planets uranus = new Planets("Uranus", "https://i.ibb.co/4d282k7/Uranus.jpg", "https://i.ibb.co/8NDwg4r/uranus-art.jpg","Uranus is known as the Sideways Planet because it actually rotates on its side. Unlike Jupiter and Saturn, considered to be gas giants, Uranus is considered to be an ice giant. It is mostly made of icy materials above its core. Uranus also spins in the opposite direction of most other plants including Earth.", "1.835 billion miles from the sun." , "Uranus has a diameter of 31,518 miles. Uranus is four times larger than Earth.", uranusHistory, uranusArt);
       planetsRepo.save(uranus);
       Planets neptune = new Planets("Neptune", "https://i.ibb.co/HTnFrt4/Neptune.jpg", "https://i.ibb.co/1JDbngT/Neptune.jpg","One of Neptune's first names was THe Planet Exterior to Uranus. More recently, it has adopted the nickname, The Last of the Gas Giants. Neptune is very cold, dark, and windy. Temperatures can reach -353 F. Neptune was also the first planet to be discovered by mathematical calculations and predictions.", "2.785 billion miles from the sun.", "Neptune has a diameter of 30,599 miles. Neptune is very similar in size to Uranus and is 3.9 times larger than Earth.", neptuneHistory, neptuneArt);
